    ...
    return InlineKeyboardMarkup(
        [
            ...
            [
                ...
                InlineKeyboardButton(
                    gm(chat_id, "maintainer"), url="https://t.me/jefer114430x"
                ),
            ],
            [
                InlineKeyboardButton(gm(chat_id, "channel"), url=config.CHANNEL_LINK),
                InlineKeyboardButton(
                    gm(chat_id, "group_support"), url="https://t.me/thekillpro30_channel"
                ),
            ],
            [
                InlineKeyboardButton(
                    gm(chat_id, "source_code"),
                    url="https://github.com/Jhomar-arch/thekillpromusicbbot",
                )
            ],
        ]
    )
