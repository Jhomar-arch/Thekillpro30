    ...
    for member in message.new_chat_members:
        if member.id == bot_id:
            ...
            return await message.reply(
                "Hola.\n"
                "Hazme admin con todos los permisos, menos anónimo.\n"
                "Gracias por invitarme aquí, para usarme, por favor usa el comando /play más el nombre de la canción.\n"
                "No olvides suscribirte a mi canal, si tienes algún problema comunicate con @jefer114430x.",
